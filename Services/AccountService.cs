...
using BCrypt.Net;
using Dotnet_Auth.Models.Accounts;
...
namespace Dotnet_Auth.Services
{
    ...
    public class AccountService : IAccountService
    {
        ...
        public AccountService(DataContext context, IJwtUtils jwtUtils, IMapper mapper, AppSettings appSettings, IEmailService emailService)
        {
            _context = context;
            _jwtUtils = jwtUtils;
            _mapper = mapper;
